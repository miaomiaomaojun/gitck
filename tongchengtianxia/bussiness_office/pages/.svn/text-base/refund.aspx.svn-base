                     ...
                     <thead>
                        <tr>
                             <th>
                                             ...
                                             日期：<input type="search" name="search" class="ind-sear" value="" onclick="layui.laydate({ elem: this, istime: true, format: 'YYYY-MM-DD' })"><i class="poss-date"  ></i>&nbsp;&nbsp;&nbsp;退款状态：<select name="sele-sta" class="sele-star"><option>-请选择-</option><option>已退款</option><option>正在退款</option><option>退款失败</option></select><button type="submit" class="but-sear"><i class="layui-icon">&#xe615;</i>搜索</button>
